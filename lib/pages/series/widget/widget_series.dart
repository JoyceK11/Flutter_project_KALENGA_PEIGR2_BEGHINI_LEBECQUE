...
class Widget_series extends StatelessWidget {
  const Widget_series({super.key});
                ...
                Positioned(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                          children: [
                            SvgPicture.asset('assets/images/ic_publisher_bicolor.svg',width:15 ,height: 15,),
                            SizedBox(width: 4.0),
                            const Text(
                              'Marvel',
                              style: TextStyle(
                      ...
                      Row(
                          children: [
                            SvgPicture.asset('assets/images/ic_tv_bicolor.svg',width:15 ,height: 15,),
                            SizedBox(width: 4.0),
                            const Text(
                              '136 episodes',
                              style: TextStyle(
